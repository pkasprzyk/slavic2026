...
NAME		:= slavic2026
GAME_TITLE	:= Red Hot Chilling Bunnies MULTI
...
NITROFS_ASSETS	:= $(shell find -L assets -name "*.png") assets/convert.sh assets/tiles/project.tmx assets/generate_from_tmx.py source/level.h
