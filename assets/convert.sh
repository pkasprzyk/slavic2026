...
$GRIT sprite_water_drops.png sprite_robot_idle.png sprite_hare_idle.png reactor_core.png sprite_fire_small.png -ftB -fh! -gTFF00FF -gt -gB8 -pS -Odefault_sprite.pal
